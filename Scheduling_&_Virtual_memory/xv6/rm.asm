...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1051:	50                   	push   %eax
    1052:	e8 08 03 00 00       	call   135f <unlink>
    ...
    1072:	50                   	push   %eax
    1073:	68 76 18 00 00       	push   $0x1876
    1078:	6a 02                	push   $0x2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1439:	0f b6 91 e0 1a 00 00 	movzbl 0x1ae0(%ecx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1577:	75 25                	jne    159e <printf+0x103>
          s = "(null)";
    1579:	c7 45 f4 8f 18 00 00 	movl   $0x188f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1644:	a1 fc 1a 00 00       	mov    0x1afc,%eax
  ...
  freep = p;
    ...
    170f:	a3 fc 1a 00 00       	mov    %eax,0x1afc
}
    1714:	90                   	nop
    1715:	c9                   	leave  
    1716:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1794:	a1 fc 1a 00 00       	mov    0x1afc,%eax
    1799:	89 45 f0             	mov    %eax,-0x10(%ebp)
    179c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    17a0:	75 23                	jne    17c5 <malloc+0x4a>
    base.s.ptr = freep = prevp = &base;
    17a2:	c7 45 f0 f4 1a 00 00 	movl   $0x1af4,-0x10(%ebp)
    17a9:	8b 45 f0             	mov    -0x10(%ebp),%eax
    17ac:	a3 fc 1a 00 00       	mov    %eax,0x1afc
    17b1:	a1 fc 1a 00 00       	mov    0x1afc,%eax
    17b6:	a3 f4 1a 00 00       	mov    %eax,0x1af4
    base.s.size = 0;
    17bb:	c7 05 f8 1a 00 00 00 	movl   $0x0,0x1af8
    17c2:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1818:	a3 fc 1a 00 00       	mov    %eax,0x1afc
      return (void*)(p + 1);
    ...
    if(p == freep)
    1825:	a1 fc 1a 00 00       	mov    0x1afc,%eax
