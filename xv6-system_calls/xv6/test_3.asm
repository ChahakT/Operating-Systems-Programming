...
main(int argc, char *argv[]) {
  ...
  13:	53                   	push   %ebx
  14:	51                   	push   %ecx
  15:	81 ec 88 00 00 00    	sub    $0x88,%esp
    int x1 = getiocount();
  1b:	e8 93 03 00 00       	call   3b3 <getiocount>
  20:	89 85 74 ff ff ff    	mov    %eax,-0x8c(%ebp)

    int rc = fork();
  26:	e8 e0 02 00 00       	call   30b <fork>
  ...
  2f:	7e 05                	jle    36 <main+0x36>
        (void) wait();
  31:	e8 e5 02 00 00       	call   31b <wait>
main(int argc, char *argv[]) {
  36:	31 ff                	xor    %edi,%edi
  38:	8d 5d 84             	lea    -0x7c(%ebp),%ebx
  3b:	eb 1e                	jmp    5b <main+0x5b>
  ...
  40:	83 ec 04             	sub    $0x4,%esp
    for (i = 0; i < 1000; i++) {
  43:	83 c7 01             	add    $0x1,%edi
            (void) read(4, buf, 1);
  46:	6a 01                	push   $0x1
  48:	53                   	push   %ebx
  49:	6a 04                	push   $0x4
  4b:	e8 db 02 00 00       	call   32b <read>
  50:	83 c4 10             	add    $0x10,%esp
    for (i = 0; i < 1000; i++) {
  53:	81 ff e8 03 00 00    	cmp    $0x3e8,%edi
  59:	74 23                	je     7e <main+0x7e>
        if (i % 2 == 0) 
  5b:	f7 c7 01 00 00 00    	test   $0x1,%edi
  ...
  6b:	53                   	push   %ebx
  6c:	6a 04                	push   $0x4
  6e:	e8 c0 02 00 00       	call   333 <write>
  73:	83 c4 10             	add    $0x10,%esp
    for (i = 0; i < 1000; i++) {
  76:	81 ff e8 03 00 00    	cmp    $0x3e8,%edi
  7c:	75 dd                	jne    5b <main+0x5b>
    }
  ...
  80:	7e 1c                	jle    9e <main+0x9e>
	int x2 = getiocount();
  82:	e8 2c 03 00 00       	call   3b3 <getiocount>
	total += (x2 - x1);
  87:	2b 85 74 ff ff ff    	sub    -0x8c(%ebp),%eax
