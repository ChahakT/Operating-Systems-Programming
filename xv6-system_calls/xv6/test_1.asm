...
main(int argc, char *argv[]) {
  ...
  char buf[100];
  (void) read(4, buf, 1);
  13:	8d 7d 84             	lea    -0x7c(%ebp),%edi
main(int argc, char *argv[]) {
  16:	53                   	push   %ebx
  17:	51                   	push   %ecx
  18:	81 ec 88 00 00 00    	sub    $0x88,%esp
  int x1 = getiocount();
  1e:	e8 60 03 00 00       	call   383 <getiocount>
  23:	89 85 74 ff ff ff    	mov    %eax,-0x8c(%ebp)
  int x2 = getiocount();
  29:	e8 55 03 00 00       	call   383 <getiocount>
  (void) read(4, buf, 1);
  ...
  35:	57                   	push   %edi
  36:	6a 04                	push   $0x4
  38:	e8 be 02 00 00       	call   2fb <read>
  int x3 = getiocount();
  3d:	e8 41 03 00 00       	call   383 <getiocount>
  (void) write(4, buf, 1);  
  ...
  int x4 = getiocount();
  51:	e8 2d 03 00 00       	call   383 <getiocount>

  printf(1, "XV6_TEST_OUTPUT %d %d %d\n", x2-x1, x3-x2, x4-x3);
  56:	29 f0                	sub    %esi,%eax
  58:	29 de                	sub    %ebx,%esi
  5a:	2b 9d 74 ff ff ff    	sub    -0x8c(%ebp),%ebx
  60:	89 04 24             	mov    %eax,(%esp)
  63:	56                   	push   %esi
  64:	53                   	push   %ebx
  65:	68 a8 07 00 00       	push   $0x7a8
  6a:	6a 01                	push   $0x1
  6c:	e8 cf 03 00 00       	call   440 <printf>
  exit();
