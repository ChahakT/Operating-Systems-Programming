...
main(int argc, char *argv[]) {
  18:	53                   	push   %ebx
  19:	8d 5d 84             	lea    -0x7c(%ebp),%ebx
  1c:	51                   	push   %ecx
  1d:	81 ec 88 00 00 00    	sub    $0x88,%esp
  int x1 = getiocount();
  23:	e8 cb 03 00 00       	call   3f3 <getiocount>
  ...
  35:	53                   	push   %ebx
  36:	6a 04                	push   $0x4
  38:	e8 2e 03 00 00       	call   36b <read>
  for (i = 0; i < 1000; i++) {
  3d:	83 c4 10             	add    $0x10,%esp
  40:	83 ee 01             	sub    $0x1,%esi
  43:	75 eb                	jne    30 <main+0x30>
  }
  int x2 = getiocount();
  45:	e8 a9 03 00 00       	call   3f3 <getiocount>
  4a:	be e8 03 00 00       	mov    $0x3e8,%esi
  ...
  5d:	53                   	push   %ebx
  5e:	6a 04                	push   $0x4
  60:	e8 0e 03 00 00       	call   373 <write>
  for (i = 0; i < 1000; i++) {
  65:	83 c4 10             	add    $0x10,%esp
  68:	83 ee 01             	sub    $0x1,%esi
  6b:	75 eb                	jne    58 <main+0x58>
  }
  int x3 = getiocount();
  6d:	e8 81 03 00 00       	call   3f3 <getiocount>
  for (i = 0; i < 1000; i++) {
  72:	31 f6                	xor    %esi,%esi
  int x3 = getiocount();
  74:	89 85 70 ff ff ff    	mov    %eax,-0x90(%ebp)
  for (i = 0; i < 1000; i++) {
  7a:	eb 1f                	jmp    9b <main+0x9b>
  7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if (i % 2 == 0) 
      (void) read(4, buf, 1);
  80:	83 ec 04             	sub    $0x4,%esp
  for (i = 0; i < 1000; i++) {
  83:	83 c6 01             	add    $0x1,%esi
      (void) read(4, buf, 1);
  86:	6a 01                	push   $0x1
  88:	53                   	push   %ebx
  89:	6a 04                	push   $0x4
  8b:	e8 db 02 00 00       	call   36b <read>
  90:	83 c4 10             	add    $0x10,%esp
  for (i = 0; i < 1000; i++) {
  93:	81 fe e8 03 00 00    	cmp    $0x3e8,%esi
  99:	74 23                	je     be <main+0xbe>
    if (i % 2 == 0) 
  9b:	f7 c6 01 00 00 00    	test   $0x1,%esi
  a1:	74 dd                	je     80 <main+0x80>
    else
      (void) write(4, buf, 1);
  a3:	83 ec 04             	sub    $0x4,%esp
  for (i = 0; i < 1000; i++) {
  a6:	83 c6 01             	add    $0x1,%esi
      (void) write(4, buf, 1);
  a9:	6a 01                	push   $0x1
  ab:	53                   	push   %ebx
  ac:	6a 04                	push   $0x4
  ae:	e8 c0 02 00 00       	call   373 <write>
  b3:	83 c4 10             	add    $0x10,%esp
  for (i = 0; i < 1000; i++) {
  b6:	81 fe e8 03 00 00    	cmp    $0x3e8,%esi
  bc:	75 dd                	jne    9b <main+0x9b>
  }
  int x4 = getiocount();
  be:	e8 30 03 00 00       	call   3f3 <getiocount>
  printf(1, "XV6_TEST_OUTPUT %d %d %d\n", x2-x1, x3-x2, x4-x3);
  c3:	8b 95 70 ff ff ff    	mov    -0x90(%ebp),%edx
  c9:	83 ec 0c             	sub    $0xc,%esp
  cc:	29 d0                	sub    %edx,%eax
  ce:	29 fa                	sub    %edi,%edx
  d0:	2b bd 74 ff ff ff    	sub    -0x8c(%ebp),%edi
  d6:	50                   	push   %eax
  d7:	52                   	push   %edx
  d8:	57                   	push   %edi
  d9:	68 18 08 00 00       	push   $0x818
  de:	6a 01                	push   $0x1
  e0:	e8 cb 03 00 00       	call   4b0 <printf>
  exit();
  e5:	83 c4 20             	add    $0x20,%esp
  e8:	e8 66 02 00 00       	call   353 <exit>
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 32 08 00 00       	mov    $0x832,%ebx
        while(*s != 0){
