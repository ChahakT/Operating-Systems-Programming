...
main(int argc, char *argv[]) {
  ...
  12:	56                   	push   %esi
    int num_proc = 20;
    int x1 = getiocount();
  13:	be 14 00 00 00       	mov    $0x14,%esi
main(int argc, char *argv[]) {
  18:	53                   	push   %ebx
  19:	51                   	push   %ecx
  1a:	83 ec 78             	sub    $0x78,%esp
    int x1 = getiocount();
  1d:	e8 91 03 00 00       	call   3b3 <getiocount>
  22:	89 c7                	mov    %eax,%edi

    int i, j, rc;
    
    for (i = 0; i < num_proc; i++) {
  24:	eb 14                	jmp    3a <main+0x3a>
  ...
  30:	e8 e6 02 00 00       	call   31b <wait>
    for (i = 0; i < num_proc; i++) {
  35:	83 ee 01             	sub    $0x1,%esi
  38:	74 56                	je     90 <main+0x90>
        rc = fork();
  3a:	e8 cc 02 00 00       	call   30b <fork>
  3f:	89 c3                	mov    %eax,%ebx
        if (rc == 0) {
  41:	85 c0                	test   %eax,%eax
  43:	75 eb                	jne    30 <main+0x30>
  45:	8d 75 84             	lea    -0x7c(%ebp),%esi
  48:	eb 21                	jmp    6b <main+0x6b>
  ...
  58:	56                   	push   %esi
  59:	6a 04                	push   $0x4
  5b:	e8 cb 02 00 00       	call   32b <read>
  60:	83 c4 10             	add    $0x10,%esp
            for (j = 0; j < 10000; j++) {
  63:	81 fb 10 27 00 00    	cmp    $0x2710,%ebx
  69:	74 20                	je     8b <main+0x8b>
                if (j % 2 == 0) 
  6b:	f6 c3 01             	test   $0x1,%bl
  6e:	74 e0                	je     50 <main+0x50>
                    (void) write(4, buf, 1);
  ...
  78:	56                   	push   %esi
  79:	6a 04                	push   $0x4
  7b:	e8 b3 02 00 00       	call   333 <write>
  80:	83 c4 10             	add    $0x10,%esp
            for (j = 0; j < 10000; j++) {
  83:	81 fb 10 27 00 00    	cmp    $0x2710,%ebx
  89:	75 e0                	jne    6b <main+0x6b>
            exit();
  8b:	e8 83 02 00 00       	call   313 <exit>
   ...
   // https://wiki.osdev.org/Shutdown
    // (void) shutdown();
    int x2 = getiocount();
  90:	e8 1e 03 00 00       	call   3b3 <getiocount>
    printf(1, "XV6_TEST_OUTPUT %d\n", x2-x1);
  95:	29 f8                	sub    %edi,%eax
  97:	52                   	push   %edx
  98:	50                   	push   %eax
  99:	68 d8 07 00 00       	push   $0x7d8
  9e:	6a 01                	push   $0x1
...
free(void *ap)
{
 ...
 645:	a1 ac 0a 00 00       	mov    0xaac,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d ac 0a 00 00    	mov    0xaac,%edi
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 ...
 79e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 ac 0a 00 00 b0 	movl   $0xab0,0xaac
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	bf b0 0a 00 00       	mov    $0xab0,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 7b6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 7c2:	00 00 00 
    if(p->s.size >= nunits){
