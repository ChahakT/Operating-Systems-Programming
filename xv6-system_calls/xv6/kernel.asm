...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 c7 7a 10 80 	movl   $0x80107ac7,(%esp)
...
80102486:	81 fb 08 55 11 80    	cmp    $0x80115508,%ebx
...
8010305b:	68 08 55 11 80       	push   $0x80115508
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 f6 58 10 80 	movl   $0x801058f6,0x14(%eax)
  p->context = (struct context*)sp;
...
801041f3:	68 c7 7a 10 80       	push   $0x80107ac7
...
80104d17:	83 ec 24             	sub    $0x24,%esp
  acquire(&iocounterlock);
80104d1a:	68 c0 4c 11 80       	push   $0x80114cc0
80104d1f:	e8 3c f8 ff ff       	call   80104560 <acquire>
  release(&iocounterlock);
80104d24:	c7 04 24 c0 4c 11 80 	movl   $0x80114cc0,(%esp)
  iocount++;
80104d2b:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
  release(&iocounterlock);
80104d32:	e8 e9 f8 ff ff       	call   80104620 <release>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104d37:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104d3a:	31 c0                	xor    %eax,%eax
80104d3c:	e8 0f ff ff ff       	call   80104c50 <argfd.constprop.0>
80104d41:	83 c4 10             	add    $0x10,%esp
80104d44:	85 c0                	test   %eax,%eax
80104d46:	78 48                	js     80104d90 <sys_read+0x80>
80104d48:	83 ec 08             	sub    $0x8,%esp
80104d4b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d4e:	50                   	push   %eax
80104d4f:	6a 02                	push   $0x2
80104d51:	e8 fa fb ff ff       	call   80104950 <argint>
80104d56:	83 c4 10             	add    $0x10,%esp
80104d59:	85 c0                	test   %eax,%eax
80104d5b:	78 33                	js     80104d90 <sys_read+0x80>
...
80104d69:	e8 32 fc ff ff       	call   801049a0 <argptr>
80104d6e:	83 c4 10             	add    $0x10,%esp
80104d71:	85 c0                	test   %eax,%eax
80104d73:	78 1b                	js     80104d90 <sys_read+0x80>
...
80104da7:	83 ec 24             	sub    $0x24,%esp
  acquire(&iocounterlock);
80104daa:	68 c0 4c 11 80       	push   $0x80114cc0
80104daf:	e8 ac f7 ff ff       	call   80104560 <acquire>
  release(&iocounterlock);
80104db4:	c7 04 24 c0 4c 11 80 	movl   $0x80114cc0,(%esp)
  iocount++;
80104dbb:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
  release(&iocounterlock);
80104dc2:	e8 59 f8 ff ff       	call   80104620 <release>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104dc7:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104dca:	31 c0                	xor    %eax,%eax
80104dcc:	e8 7f fe ff ff       	call   80104c50 <argfd.constprop.0>
80104dd1:	83 c4 10             	add    $0x10,%esp
80104dd4:	85 c0                	test   %eax,%eax
80104dd6:	78 48                	js     80104e20 <sys_write+0x80>
...
80104deb:	78 33                	js     80104e20 <sys_write+0x80>
...
80104e03:	78 1b                	js     80104e20 <sys_write+0x80>
...
8010506d:	58                   	pop    %eax
8010506e:	5a                   	pop    %edx
8010506f:	68 98 78 10 80       	push   $0x80107898
...
80105088:	68 97 78 10 80       	push   $0x80107897
...
801057fe:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105801:	8b 1d 00 55 11 80    	mov    0x80115500,%ebx
  while(ticks - ticks0 < n){
...
80105818:	68 00 55 11 80       	push   $0x80115500
8010581d:	e8 fe e6 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105822:	a1 00 55 11 80       	mov    0x80115500,%eax
...
80105890:	e8 cb ec ff ff       	call   80104560 <acquire>
  xticks = ticks;
80105895:	8b 1d 00 55 11 80    	mov    0x80115500,%ebx
  release(&tickslock);
...
801058b8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&iocounterlock);
801058bb:	68 c0 4c 11 80       	push   $0x80114cc0
801058c0:	e8 9b ec ff ff       	call   80104560 <acquire>
  iotillnow = iocount;
801058c5:	8b 1d bc a5 10 80    	mov    0x8010a5bc,%ebx
  release(&iocounterlock);
801058cb:	c7 04 24 c0 4c 11 80 	movl   $0x80114cc0,(%esp)
801058d2:	e8 49 ed ff ff       	call   80104620 <release>
  return iotillnow;
}
...
801058df:	06                   	push   %es
  pushl %fs
801058e0:	0f a0                	push   %fs
  pushl %gs
801058e2:	0f a8                	push   %gs
  pushal
801058e4:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801058e5:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801058e9:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801058eb:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801058ed:	54                   	push   %esp
  call trap
801058ee:	e8 dd 00 00 00       	call   801059d0 <trap>
  addl $4, %esp
801058f3:	83 c4 04             	add    $0x4,%esp
...
801058f6:	61                   	popa   
  popl %gs
801058f7:	0f a9                	pop    %gs
  popl %fs
801058f9:	0f a1                	pop    %fs
  popl %es
801058fb:	07                   	pop    %es
  popl %ds
801058fc:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801058fd:	83 c4 08             	add    $0x8,%esp
  iret
80105900:	cf                   	iret   
...
80105927:	c7 04 c5 02 4d 11 80 	movl   $0x8e000008,-0x7feeb2fe(,%eax,8)
8010592e:	08 00 00 8e 
80105932:	66 89 14 c5 00 4d 11 	mov    %dx,-0x7feeb300(,%eax,8)
80105939:	80 
8010593a:	c1 ea 10             	shr    $0x10,%edx
8010593d:	66 89 14 c5 06 4d 11 	mov    %dx,-0x7feeb2fa(,%eax,8)
80105944:	80 
  for(i = 0; i < 256; i++)
...
80105957:	c7 05 02 4f 11 80 08 	movl   $0xef000008,0x80114f02
8010595e:	00 00 ef 
  initlock(&tickslock, "time");
80105961:	68 dd 78 10 80       	push   $0x801078dd
80105966:	68 80 4c 11 80       	push   $0x80114c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010596b:	66 a3 00 4f 11 80    	mov    %ax,0x80114f00
80105971:	c1 e8 10             	shr    $0x10,%eax
80105974:	66 a3 06 4f 11 80    	mov    %ax,0x80114f06
  initlock(&tickslock, "time");
8010597a:	e8 61 ea ff ff       	call   801043e0 <initlock>
  initlock(&iocounterlock, "iocounter");
8010597f:	58                   	pop    %eax
80105980:	5a                   	pop    %edx
80105981:	68 e2 78 10 80       	push   $0x801078e2
80105986:	68 c0 4c 11 80       	push   $0x80114cc0
8010598b:	e8 50 ea ff ff       	call   801043e0 <initlock>
}
...
801059af:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059b3:	b8 00 4d 11 80       	mov    $0x80114d00,%eax
...
801059f4:	3e ff 24 85 90 79 10 	notrack jmp *-0x7fef8670(,%eax,4)
801059fb:	80 
    lapiceoi();
    break;
...
80105a51:	68 4c 79 10 80       	push   $0x8010794c
...
80105afc:	e8 5f ea ff ff       	call   80104560 <acquire>
      wakeup(&ticks);
80105b01:	c7 04 24 00 55 11 80 	movl   $0x80115500,(%esp)
      ticks++;
80105b08:	83 05 00 55 11 80 01 	addl   $0x1,0x80115500
      wakeup(&ticks);
...
80105b6c:	68 f4 78 10 80       	push   $0x801078f4
...
80105c08:	68 18 79 10 80       	push   $0x80107918
80105c0d:	e8 9e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c12:	83 c4 14             	add    $0x14,%esp
80105c15:	68 ec 78 10 80       	push   $0x801078ec
...
80105c20:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105c24:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
...
80105cfb:	74 52                	je     80105d4f <uartinit+0xaf>
  uart = 1;
80105cfd:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105d04:	00 00 00 
...
80105d13:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d18:	bb 10 7a 10 80       	mov    $0x80107a10,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105d30:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105d34:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
...
80105d64:	55                   	push   %ebp
  if(!uart)
80105d65:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
{
...
80105dab:	6a 00                	push   $0x0
  jmp alltraps
80105dad:	e9 2c fb ff ff       	jmp    801058de <alltraps>
...
80105db4:	6a 01                	push   $0x1
  jmp alltraps
80105db6:	e9 23 fb ff ff       	jmp    801058de <alltraps>
...
80105dbd:	6a 02                	push   $0x2
  jmp alltraps
80105dbf:	e9 1a fb ff ff       	jmp    801058de <alltraps>
...
80105dc6:	6a 03                	push   $0x3
  jmp alltraps
80105dc8:	e9 11 fb ff ff       	jmp    801058de <alltraps>
...
80105dcf:	6a 04                	push   $0x4
  jmp alltraps
80105dd1:	e9 08 fb ff ff       	jmp    801058de <alltraps>
...
80105dd8:	6a 05                	push   $0x5
  jmp alltraps
80105dda:	e9 ff fa ff ff       	jmp    801058de <alltraps>
...
80105de1:	6a 06                	push   $0x6
  jmp alltraps
80105de3:	e9 f6 fa ff ff       	jmp    801058de <alltraps>
...
80105dea:	6a 07                	push   $0x7
  jmp alltraps
80105dec:	e9 ed fa ff ff       	jmp    801058de <alltraps>
...
80105df1:	6a 08                	push   $0x8
  jmp alltraps
80105df3:	e9 e6 fa ff ff       	jmp    801058de <alltraps>
...
80105dfa:	6a 09                	push   $0x9
  jmp alltraps
80105dfc:	e9 dd fa ff ff       	jmp    801058de <alltraps>
...
80105e01:	6a 0a                	push   $0xa
  jmp alltraps
80105e03:	e9 d6 fa ff ff       	jmp    801058de <alltraps>
...
80105e08:	6a 0b                	push   $0xb
  jmp alltraps
80105e0a:	e9 cf fa ff ff       	jmp    801058de <alltraps>
...
80105e0f:	6a 0c                	push   $0xc
  jmp alltraps
80105e11:	e9 c8 fa ff ff       	jmp    801058de <alltraps>
...
80105e16:	6a 0d                	push   $0xd
  jmp alltraps
80105e18:	e9 c1 fa ff ff       	jmp    801058de <alltraps>
...
80105e1d:	6a 0e                	push   $0xe
  jmp alltraps
80105e1f:	e9 ba fa ff ff       	jmp    801058de <alltraps>
...
80105e26:	6a 0f                	push   $0xf
  jmp alltraps
80105e28:	e9 b1 fa ff ff       	jmp    801058de <alltraps>
...
80105e2f:	6a 10                	push   $0x10
  jmp alltraps
80105e31:	e9 a8 fa ff ff       	jmp    801058de <alltraps>
...
80105e36:	6a 11                	push   $0x11
  jmp alltraps
80105e38:	e9 a1 fa ff ff       	jmp    801058de <alltraps>
...
80105e3f:	6a 12                	push   $0x12
  jmp alltraps
80105e41:	e9 98 fa ff ff       	jmp    801058de <alltraps>
...
80105e48:	6a 13                	push   $0x13
  jmp alltraps
80105e4a:	e9 8f fa ff ff       	jmp    801058de <alltraps>
...
80105e51:	6a 14                	push   $0x14
  jmp alltraps
80105e53:	e9 86 fa ff ff       	jmp    801058de <alltraps>
...
80105e5a:	6a 15                	push   $0x15
  jmp alltraps
80105e5c:	e9 7d fa ff ff       	jmp    801058de <alltraps>
...
80105e63:	6a 16                	push   $0x16
  jmp alltraps
80105e65:	e9 74 fa ff ff       	jmp    801058de <alltraps>
...
80105e6c:	6a 17                	push   $0x17
  jmp alltraps
80105e6e:	e9 6b fa ff ff       	jmp    801058de <alltraps>
...
80105e75:	6a 18                	push   $0x18
  jmp alltraps
80105e77:	e9 62 fa ff ff       	jmp    801058de <alltraps>
...
80105e7e:	6a 19                	push   $0x19
  jmp alltraps
80105e80:	e9 59 fa ff ff       	jmp    801058de <alltraps>
...
80105e87:	6a 1a                	push   $0x1a
  jmp alltraps
80105e89:	e9 50 fa ff ff       	jmp    801058de <alltraps>
...
80105e90:	6a 1b                	push   $0x1b
  jmp alltraps
80105e92:	e9 47 fa ff ff       	jmp    801058de <alltraps>
...
80105e99:	6a 1c                	push   $0x1c
  jmp alltraps
80105e9b:	e9 3e fa ff ff       	jmp    801058de <alltraps>
...
80105ea2:	6a 1d                	push   $0x1d
  jmp alltraps
80105ea4:	e9 35 fa ff ff       	jmp    801058de <alltraps>
...
80105eab:	6a 1e                	push   $0x1e
  jmp alltraps
80105ead:	e9 2c fa ff ff       	jmp    801058de <alltraps>
...
80105eb4:	6a 1f                	push   $0x1f
  jmp alltraps
80105eb6:	e9 23 fa ff ff       	jmp    801058de <alltraps>
...
80105ebd:	6a 20                	push   $0x20
  jmp alltraps
80105ebf:	e9 1a fa ff ff       	jmp    801058de <alltraps>
...
80105ec6:	6a 21                	push   $0x21
  jmp alltraps
80105ec8:	e9 11 fa ff ff       	jmp    801058de <alltraps>
...
80105ecf:	6a 22                	push   $0x22
  jmp alltraps
80105ed1:	e9 08 fa ff ff       	jmp    801058de <alltraps>
...
80105ed8:	6a 23                	push   $0x23
  jmp alltraps
80105eda:	e9 ff f9 ff ff       	jmp    801058de <alltraps>
...
80105ee1:	6a 24                	push   $0x24
  jmp alltraps
80105ee3:	e9 f6 f9 ff ff       	jmp    801058de <alltraps>
...
80105eea:	6a 25                	push   $0x25
  jmp alltraps
80105eec:	e9 ed f9 ff ff       	jmp    801058de <alltraps>
...
80105ef3:	6a 26                	push   $0x26
  jmp alltraps
80105ef5:	e9 e4 f9 ff ff       	jmp    801058de <alltraps>
...
80105efc:	6a 27                	push   $0x27
  jmp alltraps
80105efe:	e9 db f9 ff ff       	jmp    801058de <alltraps>
...
80105f05:	6a 28                	push   $0x28
  jmp alltraps
80105f07:	e9 d2 f9 ff ff       	jmp    801058de <alltraps>
...
80105f0e:	6a 29                	push   $0x29
  jmp alltraps
80105f10:	e9 c9 f9 ff ff       	jmp    801058de <alltraps>
...
80105f17:	6a 2a                	push   $0x2a
  jmp alltraps
80105f19:	e9 c0 f9 ff ff       	jmp    801058de <alltraps>
...
80105f20:	6a 2b                	push   $0x2b
  jmp alltraps
80105f22:	e9 b7 f9 ff ff       	jmp    801058de <alltraps>
...
80105f29:	6a 2c                	push   $0x2c
  jmp alltraps
80105f2b:	e9 ae f9 ff ff       	jmp    801058de <alltraps>
...
80105f32:	6a 2d                	push   $0x2d
  jmp alltraps
80105f34:	e9 a5 f9 ff ff       	jmp    801058de <alltraps>
...
80105f3b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f3d:	e9 9c f9 ff ff       	jmp    801058de <alltraps>
...
80105f44:	6a 2f                	push   $0x2f
  jmp alltraps
80105f46:	e9 93 f9 ff ff       	jmp    801058de <alltraps>
...
80105f4d:	6a 30                	push   $0x30
  jmp alltraps
80105f4f:	e9 8a f9 ff ff       	jmp    801058de <alltraps>
...
80105f56:	6a 31                	push   $0x31
  jmp alltraps
80105f58:	e9 81 f9 ff ff       	jmp    801058de <alltraps>
...
80105f5f:	6a 32                	push   $0x32
  jmp alltraps
80105f61:	e9 78 f9 ff ff       	jmp    801058de <alltraps>
...
80105f68:	6a 33                	push   $0x33
  jmp alltraps
80105f6a:	e9 6f f9 ff ff       	jmp    801058de <alltraps>
...
80105f71:	6a 34                	push   $0x34
  jmp alltraps
80105f73:	e9 66 f9 ff ff       	jmp    801058de <alltraps>
...
80105f7a:	6a 35                	push   $0x35
  jmp alltraps
80105f7c:	e9 5d f9 ff ff       	jmp    801058de <alltraps>
...
80105f83:	6a 36                	push   $0x36
  jmp alltraps
80105f85:	e9 54 f9 ff ff       	jmp    801058de <alltraps>
...
80105f8c:	6a 37                	push   $0x37
  jmp alltraps
80105f8e:	e9 4b f9 ff ff       	jmp    801058de <alltraps>
...
80105f95:	6a 38                	push   $0x38
  jmp alltraps
80105f97:	e9 42 f9 ff ff       	jmp    801058de <alltraps>
...
80105f9e:	6a 39                	push   $0x39
  jmp alltraps
80105fa0:	e9 39 f9 ff ff       	jmp    801058de <alltraps>
...
80105fa7:	6a 3a                	push   $0x3a
  jmp alltraps
80105fa9:	e9 30 f9 ff ff       	jmp    801058de <alltraps>
...
80105fb0:	6a 3b                	push   $0x3b
  jmp alltraps
80105fb2:	e9 27 f9 ff ff       	jmp    801058de <alltraps>
...
80105fb9:	6a 3c                	push   $0x3c
  jmp alltraps
80105fbb:	e9 1e f9 ff ff       	jmp    801058de <alltraps>
...
80105fc2:	6a 3d                	push   $0x3d
  jmp alltraps
80105fc4:	e9 15 f9 ff ff       	jmp    801058de <alltraps>
...
80105fcb:	6a 3e                	push   $0x3e
  jmp alltraps
80105fcd:	e9 0c f9 ff ff       	jmp    801058de <alltraps>
...
80105fd4:	6a 3f                	push   $0x3f
  jmp alltraps
80105fd6:	e9 03 f9 ff ff       	jmp    801058de <alltraps>
...
80105fdd:	6a 40                	push   $0x40
  jmp alltraps
80105fdf:	e9 fa f8 ff ff       	jmp    801058de <alltraps>
...
80105fe6:	6a 41                	push   $0x41
  jmp alltraps
80105fe8:	e9 f1 f8 ff ff       	jmp    801058de <alltraps>
...
80105fef:	6a 42                	push   $0x42
  jmp alltraps
80105ff1:	e9 e8 f8 ff ff       	jmp    801058de <alltraps>
...
80105ff8:	6a 43                	push   $0x43
  jmp alltraps
80105ffa:	e9 df f8 ff ff       	jmp    801058de <alltraps>
...
80106001:	6a 44                	push   $0x44
  jmp alltraps
80106003:	e9 d6 f8 ff ff       	jmp    801058de <alltraps>
...
8010600a:	6a 45                	push   $0x45
  jmp alltraps
8010600c:	e9 cd f8 ff ff       	jmp    801058de <alltraps>
...
80106013:	6a 46                	push   $0x46
  jmp alltraps
80106015:	e9 c4 f8 ff ff       	jmp    801058de <alltraps>
...
8010601c:	6a 47                	push   $0x47
  jmp alltraps
8010601e:	e9 bb f8 ff ff       	jmp    801058de <alltraps>
...
80106025:	6a 48                	push   $0x48
  jmp alltraps
80106027:	e9 b2 f8 ff ff       	jmp    801058de <alltraps>
...
8010602e:	6a 49                	push   $0x49
  jmp alltraps
80106030:	e9 a9 f8 ff ff       	jmp    801058de <alltraps>
...
80106037:	6a 4a                	push   $0x4a
  jmp alltraps
80106039:	e9 a0 f8 ff ff       	jmp    801058de <alltraps>
...
80106040:	6a 4b                	push   $0x4b
  jmp alltraps
80106042:	e9 97 f8 ff ff       	jmp    801058de <alltraps>
...
80106049:	6a 4c                	push   $0x4c
  jmp alltraps
8010604b:	e9 8e f8 ff ff       	jmp    801058de <alltraps>
...
80106052:	6a 4d                	push   $0x4d
  jmp alltraps
80106054:	e9 85 f8 ff ff       	jmp    801058de <alltraps>
...
8010605b:	6a 4e                	push   $0x4e
  jmp alltraps
8010605d:	e9 7c f8 ff ff       	jmp    801058de <alltraps>
...
80106064:	6a 4f                	push   $0x4f
  jmp alltraps
80106066:	e9 73 f8 ff ff       	jmp    801058de <alltraps>
...
8010606d:	6a 50                	push   $0x50
  jmp alltraps
8010606f:	e9 6a f8 ff ff       	jmp    801058de <alltraps>
...
80106076:	6a 51                	push   $0x51
  jmp alltraps
80106078:	e9 61 f8 ff ff       	jmp    801058de <alltraps>
...
8010607f:	6a 52                	push   $0x52
  jmp alltraps
80106081:	e9 58 f8 ff ff       	jmp    801058de <alltraps>
...
80106088:	6a 53                	push   $0x53
  jmp alltraps
8010608a:	e9 4f f8 ff ff       	jmp    801058de <alltraps>
...
80106091:	6a 54                	push   $0x54
  jmp alltraps
80106093:	e9 46 f8 ff ff       	jmp    801058de <alltraps>
...
8010609a:	6a 55                	push   $0x55
  jmp alltraps
8010609c:	e9 3d f8 ff ff       	jmp    801058de <alltraps>
...
801060a3:	6a 56                	push   $0x56
  jmp alltraps
801060a5:	e9 34 f8 ff ff       	jmp    801058de <alltraps>
...
801060ac:	6a 57                	push   $0x57
  jmp alltraps
801060ae:	e9 2b f8 ff ff       	jmp    801058de <alltraps>
...
801060b5:	6a 58                	push   $0x58
  jmp alltraps
801060b7:	e9 22 f8 ff ff       	jmp    801058de <alltraps>
...
801060be:	6a 59                	push   $0x59
  jmp alltraps
801060c0:	e9 19 f8 ff ff       	jmp    801058de <alltraps>
...
801060c7:	6a 5a                	push   $0x5a
  jmp alltraps
801060c9:	e9 10 f8 ff ff       	jmp    801058de <alltraps>
...
801060d0:	6a 5b                	push   $0x5b
  jmp alltraps
801060d2:	e9 07 f8 ff ff       	jmp    801058de <alltraps>
...
801060d9:	6a 5c                	push   $0x5c
  jmp alltraps
801060db:	e9 fe f7 ff ff       	jmp    801058de <alltraps>
...
801060e2:	6a 5d                	push   $0x5d
  jmp alltraps
801060e4:	e9 f5 f7 ff ff       	jmp    801058de <alltraps>
...
801060eb:	6a 5e                	push   $0x5e
  jmp alltraps
801060ed:	e9 ec f7 ff ff       	jmp    801058de <alltraps>
...
801060f4:	6a 5f                	push   $0x5f
  jmp alltraps
801060f6:	e9 e3 f7 ff ff       	jmp    801058de <alltraps>
...
801060fd:	6a 60                	push   $0x60
  jmp alltraps
801060ff:	e9 da f7 ff ff       	jmp    801058de <alltraps>
...
80106106:	6a 61                	push   $0x61
  jmp alltraps
80106108:	e9 d1 f7 ff ff       	jmp    801058de <alltraps>
...
8010610f:	6a 62                	push   $0x62
  jmp alltraps
80106111:	e9 c8 f7 ff ff       	jmp    801058de <alltraps>
...
80106118:	6a 63                	push   $0x63
  jmp alltraps
8010611a:	e9 bf f7 ff ff       	jmp    801058de <alltraps>
...
80106121:	6a 64                	push   $0x64
  jmp alltraps
80106123:	e9 b6 f7 ff ff       	jmp    801058de <alltraps>
...
8010612a:	6a 65                	push   $0x65
  jmp alltraps
8010612c:	e9 ad f7 ff ff       	jmp    801058de <alltraps>
...
80106133:	6a 66                	push   $0x66
  jmp alltraps
80106135:	e9 a4 f7 ff ff       	jmp    801058de <alltraps>
...
8010613c:	6a 67                	push   $0x67
  jmp alltraps
8010613e:	e9 9b f7 ff ff       	jmp    801058de <alltraps>
...
80106145:	6a 68                	push   $0x68
  jmp alltraps
80106147:	e9 92 f7 ff ff       	jmp    801058de <alltraps>
...
8010614e:	6a 69                	push   $0x69
  jmp alltraps
80106150:	e9 89 f7 ff ff       	jmp    801058de <alltraps>
...
80106157:	6a 6a                	push   $0x6a
  jmp alltraps
80106159:	e9 80 f7 ff ff       	jmp    801058de <alltraps>
...
80106160:	6a 6b                	push   $0x6b
  jmp alltraps
80106162:	e9 77 f7 ff ff       	jmp    801058de <alltraps>
...
80106169:	6a 6c                	push   $0x6c
  jmp alltraps
8010616b:	e9 6e f7 ff ff       	jmp    801058de <alltraps>
...
80106172:	6a 6d                	push   $0x6d
  jmp alltraps
80106174:	e9 65 f7 ff ff       	jmp    801058de <alltraps>
...
8010617b:	6a 6e                	push   $0x6e
  jmp alltraps
8010617d:	e9 5c f7 ff ff       	jmp    801058de <alltraps>
...
80106184:	6a 6f                	push   $0x6f
  jmp alltraps
80106186:	e9 53 f7 ff ff       	jmp    801058de <alltraps>
...
8010618d:	6a 70                	push   $0x70
  jmp alltraps
8010618f:	e9 4a f7 ff ff       	jmp    801058de <alltraps>
...
80106196:	6a 71                	push   $0x71
  jmp alltraps
80106198:	e9 41 f7 ff ff       	jmp    801058de <alltraps>
...
8010619f:	6a 72                	push   $0x72
  jmp alltraps
801061a1:	e9 38 f7 ff ff       	jmp    801058de <alltraps>
...
801061a8:	6a 73                	push   $0x73
  jmp alltraps
801061aa:	e9 2f f7 ff ff       	jmp    801058de <alltraps>
...
801061b1:	6a 74                	push   $0x74
  jmp alltraps
801061b3:	e9 26 f7 ff ff       	jmp    801058de <alltraps>
...
801061ba:	6a 75                	push   $0x75
  jmp alltraps
801061bc:	e9 1d f7 ff ff       	jmp    801058de <alltraps>
...
801061c3:	6a 76                	push   $0x76
  jmp alltraps
801061c5:	e9 14 f7 ff ff       	jmp    801058de <alltraps>
...
801061cc:	6a 77                	push   $0x77
  jmp alltraps
801061ce:	e9 0b f7 ff ff       	jmp    801058de <alltraps>
...
801061d5:	6a 78                	push   $0x78
  jmp alltraps
801061d7:	e9 02 f7 ff ff       	jmp    801058de <alltraps>
...
801061de:	6a 79                	push   $0x79
  jmp alltraps
801061e0:	e9 f9 f6 ff ff       	jmp    801058de <alltraps>
...
801061e7:	6a 7a                	push   $0x7a
  jmp alltraps
801061e9:	e9 f0 f6 ff ff       	jmp    801058de <alltraps>
...
801061f0:	6a 7b                	push   $0x7b
  jmp alltraps
801061f2:	e9 e7 f6 ff ff       	jmp    801058de <alltraps>
...
801061f9:	6a 7c                	push   $0x7c
  jmp alltraps
801061fb:	e9 de f6 ff ff       	jmp    801058de <alltraps>
...
80106202:	6a 7d                	push   $0x7d
  jmp alltraps
80106204:	e9 d5 f6 ff ff       	jmp    801058de <alltraps>
...
8010620b:	6a 7e                	push   $0x7e
  jmp alltraps
8010620d:	e9 cc f6 ff ff       	jmp    801058de <alltraps>
...
80106214:	6a 7f                	push   $0x7f
  jmp alltraps
80106216:	e9 c3 f6 ff ff       	jmp    801058de <alltraps>
...
8010621d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106222:	e9 b7 f6 ff ff       	jmp    801058de <alltraps>
...
80106229:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010622e:	e9 ab f6 ff ff       	jmp    801058de <alltraps>
...
80106235:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010623a:	e9 9f f6 ff ff       	jmp    801058de <alltraps>
...
80106241:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106246:	e9 93 f6 ff ff       	jmp    801058de <alltraps>
...
8010624d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106252:	e9 87 f6 ff ff       	jmp    801058de <alltraps>
...
80106259:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010625e:	e9 7b f6 ff ff       	jmp    801058de <alltraps>
...
80106265:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010626a:	e9 6f f6 ff ff       	jmp    801058de <alltraps>
...
80106271:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106276:	e9 63 f6 ff ff       	jmp    801058de <alltraps>
...
8010627d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106282:	e9 57 f6 ff ff       	jmp    801058de <alltraps>
...
80106289:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010628e:	e9 4b f6 ff ff       	jmp    801058de <alltraps>
...
80106295:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010629a:	e9 3f f6 ff ff       	jmp    801058de <alltraps>
...
801062a1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062a6:	e9 33 f6 ff ff       	jmp    801058de <alltraps>
...
801062ad:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062b2:	e9 27 f6 ff ff       	jmp    801058de <alltraps>
...
801062b9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062be:	e9 1b f6 ff ff       	jmp    801058de <alltraps>
...
801062c5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062ca:	e9 0f f6 ff ff       	jmp    801058de <alltraps>
...
801062d1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062d6:	e9 03 f6 ff ff       	jmp    801058de <alltraps>
...
801062dd:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062e2:	e9 f7 f5 ff ff       	jmp    801058de <alltraps>
...
801062e9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062ee:	e9 eb f5 ff ff       	jmp    801058de <alltraps>
...
801062f5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062fa:	e9 df f5 ff ff       	jmp    801058de <alltraps>
...
80106301:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106306:	e9 d3 f5 ff ff       	jmp    801058de <alltraps>
...
8010630d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106312:	e9 c7 f5 ff ff       	jmp    801058de <alltraps>
...
80106319:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010631e:	e9 bb f5 ff ff       	jmp    801058de <alltraps>
...
80106325:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010632a:	e9 af f5 ff ff       	jmp    801058de <alltraps>
...
80106331:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106336:	e9 a3 f5 ff ff       	jmp    801058de <alltraps>
...
8010633d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106342:	e9 97 f5 ff ff       	jmp    801058de <alltraps>
...
80106349:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010634e:	e9 8b f5 ff ff       	jmp    801058de <alltraps>
...
80106355:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010635a:	e9 7f f5 ff ff       	jmp    801058de <alltraps>
...
80106361:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106366:	e9 73 f5 ff ff       	jmp    801058de <alltraps>
...
8010636d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106372:	e9 67 f5 ff ff       	jmp    801058de <alltraps>
...
80106379:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010637e:	e9 5b f5 ff ff       	jmp    801058de <alltraps>
...
80106385:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010638a:	e9 4f f5 ff ff       	jmp    801058de <alltraps>
...
80106391:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106396:	e9 43 f5 ff ff       	jmp    801058de <alltraps>
...
8010639d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063a2:	e9 37 f5 ff ff       	jmp    801058de <alltraps>
...
801063a9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063ae:	e9 2b f5 ff ff       	jmp    801058de <alltraps>
...
801063b5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063ba:	e9 1f f5 ff ff       	jmp    801058de <alltraps>
...
801063c1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063c6:	e9 13 f5 ff ff       	jmp    801058de <alltraps>
...
801063cd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063d2:	e9 07 f5 ff ff       	jmp    801058de <alltraps>
...
801063d9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063de:	e9 fb f4 ff ff       	jmp    801058de <alltraps>
...
801063e5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063ea:	e9 ef f4 ff ff       	jmp    801058de <alltraps>
...
801063f1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063f6:	e9 e3 f4 ff ff       	jmp    801058de <alltraps>
...
801063fd:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106402:	e9 d7 f4 ff ff       	jmp    801058de <alltraps>
...
80106409:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010640e:	e9 cb f4 ff ff       	jmp    801058de <alltraps>
...
80106415:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010641a:	e9 bf f4 ff ff       	jmp    801058de <alltraps>
...
80106421:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106426:	e9 b3 f4 ff ff       	jmp    801058de <alltraps>
...
8010642d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106432:	e9 a7 f4 ff ff       	jmp    801058de <alltraps>
...
80106439:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010643e:	e9 9b f4 ff ff       	jmp    801058de <alltraps>
...
80106445:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010644a:	e9 8f f4 ff ff       	jmp    801058de <alltraps>
...
80106451:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106456:	e9 83 f4 ff ff       	jmp    801058de <alltraps>
...
8010645d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106462:	e9 77 f4 ff ff       	jmp    801058de <alltraps>
...
80106469:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010646e:	e9 6b f4 ff ff       	jmp    801058de <alltraps>
...
80106475:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010647a:	e9 5f f4 ff ff       	jmp    801058de <alltraps>
...
80106481:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106486:	e9 53 f4 ff ff       	jmp    801058de <alltraps>
...
8010648d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106492:	e9 47 f4 ff ff       	jmp    801058de <alltraps>
...
80106499:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010649e:	e9 3b f4 ff ff       	jmp    801058de <alltraps>
...
801064a5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064aa:	e9 2f f4 ff ff       	jmp    801058de <alltraps>
...
801064b1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064b6:	e9 23 f4 ff ff       	jmp    801058de <alltraps>
...
801064bd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064c2:	e9 17 f4 ff ff       	jmp    801058de <alltraps>
...
801064c9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064ce:	e9 0b f4 ff ff       	jmp    801058de <alltraps>
...
801064d5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064da:	e9 ff f3 ff ff       	jmp    801058de <alltraps>
...
801064e1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064e6:	e9 f3 f3 ff ff       	jmp    801058de <alltraps>
...
801064ed:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064f2:	e9 e7 f3 ff ff       	jmp    801058de <alltraps>
...
801064f9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064fe:	e9 db f3 ff ff       	jmp    801058de <alltraps>
...
80106505:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010650a:	e9 cf f3 ff ff       	jmp    801058de <alltraps>
...
80106511:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106516:	e9 c3 f3 ff ff       	jmp    801058de <alltraps>
...
8010651d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106522:	e9 b7 f3 ff ff       	jmp    801058de <alltraps>
...
80106529:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010652e:	e9 ab f3 ff ff       	jmp    801058de <alltraps>
...
80106535:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010653a:	e9 9f f3 ff ff       	jmp    801058de <alltraps>
...
80106541:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106546:	e9 93 f3 ff ff       	jmp    801058de <alltraps>
...
8010654d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106552:	e9 87 f3 ff ff       	jmp    801058de <alltraps>
...
80106559:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010655e:	e9 7b f3 ff ff       	jmp    801058de <alltraps>
...
80106565:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010656a:	e9 6f f3 ff ff       	jmp    801058de <alltraps>
...
80106571:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106576:	e9 63 f3 ff ff       	jmp    801058de <alltraps>
...
8010657d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106582:	e9 57 f3 ff ff       	jmp    801058de <alltraps>
...
80106589:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010658e:	e9 4b f3 ff ff       	jmp    801058de <alltraps>
...
80106595:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010659a:	e9 3f f3 ff ff       	jmp    801058de <alltraps>
...
801065a1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065a6:	e9 33 f3 ff ff       	jmp    801058de <alltraps>
...
801065ad:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065b2:	e9 27 f3 ff ff       	jmp    801058de <alltraps>
...
801065b9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065be:	e9 1b f3 ff ff       	jmp    801058de <alltraps>
...
801065c5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065ca:	e9 0f f3 ff ff       	jmp    801058de <alltraps>
...
801065d1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065d6:	e9 03 f3 ff ff       	jmp    801058de <alltraps>
...
801065dd:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065e2:	e9 f7 f2 ff ff       	jmp    801058de <alltraps>
...
801065e9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065ee:	e9 eb f2 ff ff       	jmp    801058de <alltraps>
...
801065f5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065fa:	e9 df f2 ff ff       	jmp    801058de <alltraps>
...
80106601:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106606:	e9 d3 f2 ff ff       	jmp    801058de <alltraps>
...
8010660d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106612:	e9 c7 f2 ff ff       	jmp    801058de <alltraps>
...
80106619:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010661e:	e9 bb f2 ff ff       	jmp    801058de <alltraps>
...
80106625:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010662a:	e9 af f2 ff ff       	jmp    801058de <alltraps>
...
80106631:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106636:	e9 a3 f2 ff ff       	jmp    801058de <alltraps>
...
8010663d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106642:	e9 97 f2 ff ff       	jmp    801058de <alltraps>
...
80106649:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010664e:	e9 8b f2 ff ff       	jmp    801058de <alltraps>
...
80106655:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010665a:	e9 7f f2 ff ff       	jmp    801058de <alltraps>
...
80106661:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106666:	e9 73 f2 ff ff       	jmp    801058de <alltraps>
...
8010666d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106672:	e9 67 f2 ff ff       	jmp    801058de <alltraps>
...
80106679:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010667e:	e9 5b f2 ff ff       	jmp    801058de <alltraps>
...
80106685:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010668a:	e9 4f f2 ff ff       	jmp    801058de <alltraps>
...
80106691:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106696:	e9 43 f2 ff ff       	jmp    801058de <alltraps>
...
8010669d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066a2:	e9 37 f2 ff ff       	jmp    801058de <alltraps>
...
801066a9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066ae:	e9 2b f2 ff ff       	jmp    801058de <alltraps>
...
801066b5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066ba:	e9 1f f2 ff ff       	jmp    801058de <alltraps>
...
801066c1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066c6:	e9 13 f2 ff ff       	jmp    801058de <alltraps>
...
801066cd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066d2:	e9 07 f2 ff ff       	jmp    801058de <alltraps>
...
801066d9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066de:	e9 fb f1 ff ff       	jmp    801058de <alltraps>
...
801066e5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066ea:	e9 ef f1 ff ff       	jmp    801058de <alltraps>
...
801066f1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066f6:	e9 e3 f1 ff ff       	jmp    801058de <alltraps>
...
801066fd:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106702:	e9 d7 f1 ff ff       	jmp    801058de <alltraps>
...
80106709:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010670e:	e9 cb f1 ff ff       	jmp    801058de <alltraps>
...
80106715:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010671a:	e9 bf f1 ff ff       	jmp    801058de <alltraps>
...
80106721:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106726:	e9 b3 f1 ff ff       	jmp    801058de <alltraps>
...
8010672d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106732:	e9 a7 f1 ff ff       	jmp    801058de <alltraps>
...
80106739:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010673e:	e9 9b f1 ff ff       	jmp    801058de <alltraps>
...
80106745:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010674a:	e9 8f f1 ff ff       	jmp    801058de <alltraps>
...
80106751:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106756:	e9 83 f1 ff ff       	jmp    801058de <alltraps>
...
8010675d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106762:	e9 77 f1 ff ff       	jmp    801058de <alltraps>
...
80106769:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010676e:	e9 6b f1 ff ff       	jmp    801058de <alltraps>
...
80106775:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010677a:	e9 5f f1 ff ff       	jmp    801058de <alltraps>
...
80106781:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106786:	e9 53 f1 ff ff       	jmp    801058de <alltraps>
...
8010678d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106792:	e9 47 f1 ff ff       	jmp    801058de <alltraps>
...
80106799:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010679e:	e9 3b f1 ff ff       	jmp    801058de <alltraps>
...
801067a5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067aa:	e9 2f f1 ff ff       	jmp    801058de <alltraps>
...
801067b1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067b6:	e9 23 f1 ff ff       	jmp    801058de <alltraps>
...
801067bd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067c2:	e9 17 f1 ff ff       	jmp    801058de <alltraps>
...
801067c9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067ce:	e9 0b f1 ff ff       	jmp    801058de <alltraps>
...
801067d5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067da:	e9 ff f0 ff ff       	jmp    801058de <alltraps>
...
801067e1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067e6:	e9 f3 f0 ff ff       	jmp    801058de <alltraps>
...
801067ed:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067f2:	e9 e7 f0 ff ff       	jmp    801058de <alltraps>
...
801067f9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067fe:	e9 db f0 ff ff       	jmp    801058de <alltraps>
...
80106805:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010680a:	e9 cf f0 ff ff       	jmp    801058de <alltraps>
...
80106811:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106816:	e9 c3 f0 ff ff       	jmp    801058de <alltraps>
...
8010691d:	68 18 7a 10 80       	push   $0x80107a18
...
801069fe:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80106a05:	ff 00 00 
80106a08:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
80106a0f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a12:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
80106a19:	ff 00 00 
80106a1c:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
80106a23:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a26:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
80106a2d:	ff 00 00 
80106a30:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
80106a37:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a3a:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
80106a41:	ff 00 00 
80106a44:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
80106a4b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106a4e:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106a74:	a1 04 55 11 80       	mov    0x80115504,%eax
...
80106c0f:	68 5d 7a 10 80       	push   $0x80107a5d
...
80106d79:	68 95 7a 10 80       	push   $0x80107a95
...
80106ddb:	68 ad 7a 10 80       	push   $0x80107aad
...
80106ebc:	68 c9 7a 10 80       	push   $0x80107ac9
...
80106f5f:	a3 04 55 11 80       	mov    %eax,0x80115504
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f93:	68 da 7a 10 80       	push   $0x80107ada
...
80107079:	68 fe 7a 10 80       	push   $0x80107afe
8010707e:	e8 0d 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107083:	83 ec 0c             	sub    $0xc,%esp
80107086:	68 e4 7a 10 80       	push   $0x80107ae4
